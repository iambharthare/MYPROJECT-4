			...
			<table width="100%" align="center">
				<tr>
					<td align="center"><label> Student Name :</label> <input
						...
						<%-- <%=HTMLUtility.getList("name", ServletUtility.getParameter("name", request), slist)%> --%>
						&emsp; <label>RollNo :</label> <%=HTMLUtility.getList("rollnum", String.valueOf(bean.getID()), clist)%>
